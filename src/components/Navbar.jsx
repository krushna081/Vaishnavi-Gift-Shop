    ...
    <>
      <motion.nav
        ...
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
          scrolled
            ? "bg-dark-maroon/95 backdrop-blur-md shadow-lg shadow-black/20"
            : "bg-transparent"
        }`}
      >
          ...
          <div className="flex items-center justify-between h-14 lg:h-20">
            ...
            <div className="hidden lg:flex items-center gap-6">
              {navLinks.map((link) => (
                <motion.button
                  ...
                  className="text-cream/80 hover:text-gold transition-colors duration-300 text-sm font-body font-medium tracking-wide relative group"
            ...
            <div className="flex items-center gap-2">
              <motion.a
                ...
                whileTap={{ scale: 0.9 }}
                className="lg:hidden h-9 w-9 rounded-full bg-green-500 flex items-center justify-center"
              >
              ...
              <motion.button
                ...
                className="lg:hidden text-cream p-1.5"
                whileTap={{ scale: 0.9 }}
              >
        ...
        {isOpen && (
          ...
          >
            ...
            <motion.div
              ...
              className="absolute right-0 top-0 bottom-0 w-[280px] bg-dark-maroon/98 backdrop-blur-lg border-l border-gold/10"
            >
                ...
                <div className="flex-1 px-4 space-y-1">
                  {navLinks.map((link, i) => (
                    <motion.button
                      ...
                      className="block w-full text-left py-3.5 px-4 text-cream/80 hover:text-gold hover:bg-gold/10 rounded-xl transition-all duration-300 font-body text-base font-medium"
                    >
                      {link.name}
                    </motion.button>
                  ))}
