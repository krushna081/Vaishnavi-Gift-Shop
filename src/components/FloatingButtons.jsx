  ...
  return (
    <div className="fixed bottom-20 lg:bottom-6 right-4 sm:right-6 z-50 flex flex-col items-center gap-3">
      ...
      <motion.a
        ...
        title="Call Now"
      >
        <svg viewBox="0 0 24 24" fill="none" stroke="#5A002C" strokeWidth="2" className="w-7 h-7">
      ...
      <AnimatePresence>
        {showScroll && (
          <motion.button
            ...
            onClick={scrollToTop}
            className="w-10 h-10 rounded-full bg-dark-maroon/80 border border-gold/20 flex items-center justify-center text-gold hover:bg-gold hover:text-dark-maroon transition-all duration-300"
            whileHover={{ scale: 1.1 }}
            whileTap={{ scale: 0.9 }}
            title="Back to top"
          >
